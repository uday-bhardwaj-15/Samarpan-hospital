...
const ThreeDCarousel = ({
  ...
  return (
    <section className="bg-transparent w-full flex items-center justify-center">
        ...
        >
          <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
            {items.map((item, index) => (
              ...
              >
                <Card className="overflow-hidden h-[500px] flex flex-col hover:shadow-lg">
                  <div
                  ...
                  >
                    ...
                    <div className="relative z-10 text-center text-white">
                      <h3 className="text-2xl font-bold mb-2">
                        {item.brand ? item.brand.toUpperCase() : item.title.toUpperCase()}
                      </h3>
                    ...
                    <div className="mt-4">
                      <div className="flex flex-wrap gap-2 mb-4">
                        {item.tags.map((tag, idx) => (
                          <span key={idx} className="px-2 py-1 bg-gray-50 text-gray-600 rounded-full text-xs">
                            {tag}
                          </span>
                        ))}
                      </div>

                      <a href={item.link} className="text-blue-600 flex items-center hover:underline relative group">
...
export { ThreeDCarousel as ThreeDImageCarousel }
