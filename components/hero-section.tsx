...
//                   <div className="relative bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 hover:border-pink-300 h-[126px]">
...
// }
"use client";
import { Calendar, UserSearch, Stethoscope, FlaskConical } from "lucide-react";
...
const quickActions = [
  {
    icon: Calendar,
    title: "Appointments",
    description: "New or returning patients can schedule an appointment",
  },
  {
    icon: UserSearch,
    title: "Find a Doctor",
    description: "Find a doctor who's the perfect fit",
  },
  {
    icon: Stethoscope,
    title: "Medical Services",
    description: "Access new technology, treatments, and research",
  },
  {
    icon: FlaskConical,
    title: "Clinical Trials",
    description: "Participate in clinical trials for medical advancements",
  },
];
...
export function HeroSection() {
  return (
    <section className="relative">
      {/* Hero Image Container with Blue Frame */}
        ...
        <div className="relative" style={{ padding: "8px" }}>
          ...
          <div className="relative h-[400px] md:h-[500px] overflow-hidden">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, rgba(30, 58, 95, 0.95) 0%, rgba(37, 99, 235, 0.85) 40%, rgba(37, 99, 235, 0.4) 70%, transparent 100%)",
              }}
            />

            {/* Hero Content */}
            <div className="relative z-10 h-full flex flex-col justify-center px-8 md:px-12 lg:px-16 max-w-2xl">
              <h1
              ...
              {/* Award Badge */}
              <div
                className="mt-8 inline-flex items-center gap-3 px-4 py-3 rounded-sm shadow-lg max-w-fit"
                style={{ backgroundColor: "rgba(255, 255, 255, 0.95)" }}
              >
                <div
                  className="flex flex-col items-center justify-center px-3 py-2 rounded-sm"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0 shadow-xl">
          {quickActions.map((action, index) => (
            <a
              key={action.title}
              href="#"
              className={`flex flex-col items-start p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group cursor-pointer ${
                index === 0 ? "rounded-l-sm" : ""
              } ${index === quickActions.length - 1 ? "rounded-r-sm" : ""}`}
              style={{
